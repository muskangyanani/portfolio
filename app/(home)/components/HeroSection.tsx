  ...
  return (
    <div className='flex items-center justify-center min-h-[60vh]'>
      <div className='space-y-4 text-center'>
        ...
        <p className='text-lg text-gray-400 text-center'>A third year BTech student passionate about Computer Science and development. Proficient in front-end technologies and eager to delve into back-end development, I am enthusiastic about learning new technologies to enhance my skills further.</p>
